...
This contains the prompts used during development, including the initial setup, task implementations, testing, and layout polish.

---

## 1. Project Setup, Tech Stack & Folder Structure

I am working on the Entrata AI Coding Challenge using React 19, Vite, Tailwind CSS v4, Lucide React icons, and Vitest. Set up the workspace with a clean folder structure containing task1 for the profile form component and task2 for the cache demo layer, alongside App.jsx and root configuration files.
...
Phone number: optional, but ignore any spaces or dashes and check for a valid country code pattern.
